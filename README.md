...
Select an element, adjust typography, spacing, alignment, color, and text in place, then export the edited page as an HTML snapshot, long image, image-based PDF, or browser presentation.
...
1. Go to the [Releases](https://github.com/ningsiii/ClickDeck/releases) page and download `ClickDeck-v1.3.1.zip`.
2. Extract the ZIP file to a folder on your computer.
3. Open Chrome or Edge and navigate to `chrome://extensions/` or `edge://extensions/`.
4. Enable **Developer mode** in the top right corner.
5. Click **Load unpacked** and select the extracted folder.
6. See the release notes in [`RELEASE_1.3.1.md`](RELEASE_1.3.1.md) if you want a short summary of what changed.
...
你可以直接选择页面元素，调整字号、间距、对齐、颜色和文本内容，然后把修改后的页面导出为 HTML 快照、长图、图片型 PDF，或直接进入浏览器演示模式。
...
1. 前往 [Releases](https://github.com/ningsiii/ClickDeck/releases) 页面，下载 `ClickDeck-v1.3.1.zip`。
...
6. 如果你想先快速了解这版更新，可以查看 [`RELEASE_1.3.1.md`](RELEASE_1.3.1.md)。
