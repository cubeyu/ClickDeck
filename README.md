...
1. Go to the [Releases](https://github.com/ningsiii/ClickDeck/releases) page and download `ClickDeck-v1.2.1.zip`.
2. Extract the ZIP file to a folder on your computer.
3. Open Chrome or Edge and navigate to `chrome://extensions/` or `edge://extensions/`.
4. Enable **Developer mode** in the top right corner.
5. Click **Load unpacked** and select the extracted folder.
6. See the release notes in [`RELEASE_1.2.1.md`](RELEASE_1.2.1.md) if you want a short summary of what changed.
...
1. 前往 [Releases](https://github.com/ningsiii/ClickDeck/releases) 页面，下载 `ClickDeck-v1.2.1.zip`。
...
6. 如果你想先快速了解这版更新，可以查看 [`RELEASE_1.2.1.md`](RELEASE_1.2.1.md)。
