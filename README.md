...
1. Go to the [Releases](https://github.com/ningsiii/ClickDeck/releases) page and download `ClickDeck-v1.2.0.zip`.
...
1. 前往 [Releases](https://github.com/ningsiii/ClickDeck/releases) 页面，下载 `ClickDeck-v1.2.0.zip`。
