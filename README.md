...
6. See the release notes in [`RELEASE_1.3.2.md`](RELEASE_1.3.2.md) if you want a short summary of what changed.
...
6. 如果你想先快速了解这版更新，可以查看 [`RELEASE_1.3.2.md`](RELEASE_1.3.2.md)。
